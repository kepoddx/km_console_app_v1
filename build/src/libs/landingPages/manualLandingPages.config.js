...
var assetsDir = path.join(process.cwd(), '_assets');
var pages = [
    {
        site: "knoxville",
        name: "Knox Biz",
...
var ManualLandingPagesConfig = /** @class */ (function () {
    function ManualLandingPagesConfig() {
    }
    ManualLandingPagesConfig.prototype.getManualPages$ = function () {
        return rxjs_1.of(pages);
    };
    ManualLandingPagesConfig.prototype.getManualPage$ = function (pageName) {
        return rxjs_1.of(pages)
            .pipe(operators_1.map(function (pages) { return pages.filter(function (page) { return page.name === pageName; }); }));
    };
    ManualLandingPagesConfig.prototype.getPagesBySite$ = function (siteName) {
        return rxjs_1.of(pages)
            .pipe(operators_1.map(function (pages) { return pages.filter(function (page) { return page.name === siteName; }); }));
    };
    return ManualLandingPagesConfig;
}());
exports.default = ManualLandingPagesConfig;
//# sourceMappingURL=manualLandingPages.config.js.map